    ...
    <div class="container">
        ...
        <div class="row top_content">
            ...
            <div class="col-lg-3 col-md-6 top_col">
                ...
                <div class="top_item">
                    <a href="#">
                        <div class="top_item_image"><img src="<?=base_url()?>assets/images/top_3.jpg" alt="https://unsplash.com/@anikindimitry"></div>
                        <div class="top_item_content">
                            <div class="top_item_price">From $890</div>
            ...
            <div class="col-lg-3 col-md-6 top_col">
                ...
                <div class="top_item">
                    <a href="#">
                        <div class="top_item_image"><img src="<?=base_url()?>assets/images/top_4.jpg" alt="https://unsplash.com/@hellolightbulb"></div>
                        <div class="top_item_content">
                            <div class="top_item_price">From $890</div>
...
<div class="last">
    ...
    <div class="last_background parallax-window" data-parallax="scroll" data-image-src="" data-speed="0.8"></div>

    <div class="container">
        <div class="row">
            <div class="last_logo"><img src="<?=base_url()?>assets/images/last_logo.png" alt=""></div>
            <div class="col-lg-6 last_col">
                <div class="last_item">
                    <div class="last_item_content">
                        <div class="last_subtitle">RETRIEVE lost Documents</div>
                        <div class="last_percent"></div>
                        <div class="last_title">Garantie</div>
                        <div class="last_text">RETRIEVE vous offres un moyen simple et efficace de retrouver vos documents egarees. nous vous notifions immediatement apres trouvaille de vos pieces</div>
                        <div class="button last_button"><a href="<?=base_url()?>member">M'inscrire</a></div>
                    </div>
                </div>
            </div>
            <div class="col-lg-6 last_col">
                <div class="last_item">
                    <div class="last_item_content">
                        <div class="last_subtitle">RETRIEVE LOST DOCUMENTS</div>
                        <div class="last_percent"></div>
                        <div class="last_title">Efficace</div>
                        <div class="last_text">Souscrivez a nos offres forfaitaires pour rester informaer sur les eventuels pieces retrouvées vous concernant de prèt ou de loin.</div>
                        <div class="button last_button"><a href="<?=base_url()?>member">M'inscrire</a></div>
                    </div>
                </div>
            </div>
...
<div class="video_section d-flex flex-column align-items-center justify-content-center">
    ...
    <div class="video_background parallax-window" data-parallax="scroll" data-image-src="<?=base_url()?>assets/img/Untitled-2.png" data-speed="0.8"></div>
    <div class="video_content">
        <div class="video_title">RETRIEVE</div>
        <div class="video_subtitle">Find your lost documents | Comment ca marche ?</div>
        ...
        <div class="row">
            <div class="col">
                <div class="popular_content d-flex flex-md-row flex-column flex-wrap align-items-md-center align-items-start justify-content-md-between justify-content-start">
                    ...
                    <div class="popular_item">
                        <a href="offers.html">
                            <img src="<?=base_url()?>assets/images/popular_2.jpg" alt="https://unsplash.com/@michael75">
                            <div class="popular_item_content">
                                <div class="popular_item_price">From $890</div>
                    ...
                    <div class="popular_item">
                        <a href="offers.html">
                            <img src="<?=base_url()?>assets/images/popular_3.jpg" alt="https://unsplash.com/@sapegin">
                            <div class="popular_item_content">
                                <div class="popular_item_price">From $890</div>
                    ...
                    <div class="popular_item">
                        <a href="offers.html">
                            <img src="<?=base_url()?>assets/images/popular_4.jpg" alt="https://unsplash.com/@kensuarez">
                            <div class="popular_item_content">
                                <div class="popular_item_price">From $890</div>
                    ...
                    <div class="popular_item">
                        <a href="offers.html">
                            <img src="<?=base_url()?>assets/images/popular_5.jpg" alt="https://unsplash.com/@noahbasle">
                            <div class="popular_item_content">
                                <div class="popular_item_price">From $890</div>
                    ...
                    <div class="popular_item">
                        <a href="offers.html">
                            <img src="<?=base_url()?>assets/images/popular_6.jpg" alt="https://unsplash.com/@seb">
                            <div class="popular_item_content">
                                <div class="popular_item_price">From $890</div>
    ...
    <div class="container">
        <div class="row">
            <div class="col">
                <div class="section_title text-center">
                    <h2>RETRIEVE</h2>
                    <div>Retrouvez nous au cameroun !</div>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="owl-carousel owl-theme special_slider">
                ...
                <div class="owl-item">
                    <div class="special_item">
                        <div class="special_item_background"><img src="<?=base_url()?>assets/images/special_1.jpg" alt="https://unsplash.com/@garciasaldana_"></div>
                        <div class="special_item_content text-center">
                            <div class="special_category">Retrieve</div>
                            <div class="special_title"><a href="offers.html">Bafoussam</a></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="owl-item">
                    <div class="special_item d-flex flex-column align-items-center justify-content-center">
                        <div class="special_item_background"><img src="<?=base_url()?>assets/images/special_1.jpg" alt="https://unsplash.com/@varshesh"></div>
                        <div class="special_item_content text-center">
                            <div class="special_category">Retrieve</div>
                            <div class="special_title"><a href="offers.html">Yaounde</a></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="owl-item">
                    <div class="special_item d-flex flex-column align-items-center justify-content-center">
                        <div class="special_item_background"><img src="<?=base_url()?>assets/images/special_1.jpg" alt="https://unsplash.com/@paulgilmore_"></div>
                        <div class="special_item_content text-center">
                            <div class="special_category">Retrieve</div>
                            <div class="special_title"><a href="offers.html">Douala</a></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="owl-item">
                    <div class="special_item d-flex flex-column align-items-center justify-content-center">
                        <div class="special_item_background"><img src="<?=base_url()?>assets/images/special_1.jpg" alt="https://unsplash.com/@hellolightbulb"></div>
                        <div class="special_item_content text-center">
                            <div class="special_category">Retrieve</div>
                            <div class="special_title"><a href="offers.html">Ebolowa</a></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="owl-item">
                    <div class="special_item d-flex flex-column align-items-center justify-content-center">
                        <div class="special_item_background"><img src="<?=base_url()?>assets/images/special_1.jpg" alt="https://unsplash.com/@dnevozhai"></div>
                        <div class="special_item_content text-center">
                            <div class="special_category">Retrieve</div>
                            <div class="special_title"><a href="offers.html">Bafang</a></div>
                        </div>
                    </div>
                </div>
