            ...
            <div class="col">
                <div class="home_content">
                    <div class="home_content_inner">
                        <div class="home_title">Bienvenue <?= $CI->users->getOneData($_SESSION['re_userid'], "prenom"); ?> ==>Villes</div>
                ...
                <div class="contact">
                    ...
                    ?>
			                ...
			                <div class="col-md-12" style="background: none;">
			                            ...
			                            <a href="<?= base_url() ?><?= $_SESSION['abbr_lang'] ?? 'fr'?>/dashboard/ville" class="btn btn-primary btn-sm active"><i class="fa fa-eye"></i>&nbsp; Villes Disponibles</a>
			                    ...
			                    <div class="tab-content">
			                        <div class="tab-pane active" id="tab_1-1"><br><hr>
			                            <h3>Liste Globale des Villes :</h3><br>
                                        <?php
                    $val = $CI->ville->getAllville();
                    if ($val == NULL) {
                        ?>
                        vide
                        <?php
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <h1 class="mdc-card__title mdc-card__title--large">Liste des Villes Inscrites</h1>
                                <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#addUsers">Nouvele Ville</button>
                            </div>
                                ...
                                <table class="table" style="margin-top:15px;">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($val as $row):
                                            ?>
                                            <tr>
                                                <td class="text-right"><button class="edit-elemt btn btn-sm btn-success" data-edit="users" id="<?= $row->id ?>" data-toggle="modal" data-target="#editUsers" data-mdc-auto-init="MDCRipple"><i class="fa fa-pencil text-blue"></i></button></td>
                                                <td><?= $row->libeller ?></td>
                                                <td><?= $row->code ?></td>
