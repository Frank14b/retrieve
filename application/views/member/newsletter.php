            ...
            <div class="col">
                <div class="home_content">
                    <div class="home_content_inner">
                        <div class="home_title">Bienvenue <?= $CI->users->getOneData($_SESSION['re_userid'], "prenom"); ?> ==> Abonnes</div>
                ...
                <div class="contact">
                    ...
                    ?>
			                ...
			                <div class="col-md-12" style="background: none;">
	                                    ...
	                                    <a href="<?= base_url() ?><?= $_SESSION['abbr_lang'] ?? 'fr'?>/dashboard/newsletter" class="btn btn-success btn-sm active"><i class="fa fa-picture"></i>&nbsp; Abones Newsletter</a>
			                    ...
			                    <div class="tab-content">
			                        <div class="tab-pane active" id="tab_1-1"><br><hr>
			                            <h3>Liste Globale des Abones :</h3><br>
                                        <?php
                    $val = $CI->newsletter->getAllnewsletter();
                    if ($val == NULL) {
                        ?>
                        vide
                        <?php
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <h1 class="mdc-card__title mdc-card__title--large">Liste des Abones</h1>
